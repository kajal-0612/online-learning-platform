    ...
    <div className='shadow rounded-xl'>
        {course?.bannerImageUrl ? (
          <Image src={course?.bannerImageUrl} alt={course?.name}
           ...
           className={'w-full aspect-video rounded-t-xl object-cover'}></Image>
        ) : (
          <div className='w-full aspect-video rounded-t-xl bg-gray-200 flex items-center justify-center'>
